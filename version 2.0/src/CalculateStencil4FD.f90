    ...
    do k = kmin, kmax
        do j = jmin, jmax
            do i = imin, imax
                ...
                S(row, 0,0,0) = -90.0_rp*h/12.0_rp

                S(row, 0,0,-2) = -1.0_rp*h/12.0_rp
                S(row, 0,0,-1) = +16.0_rp*h/12.0_rp
                S(row, 0,0,+1) = +16.0_rp*h/12.0_rp
                S(row, 0,0,+2) = -1.0_rp*h/12.0_rp

                S(row, 0,-2,0) = -1.0_rp*h/12.0_rp
                S(row, 0,-1,0) = +16.0_rp*h/12.0_rp
                S(row, 0,+1,0) = +16.0_rp*h/12.0_rp
                S(row, 0,+2,0) = -1.0_rp*h/12.0_rp

                S(row, -2,0,0) = -1.0_rp*h/12.0_rp
                S(row, -1,0,0) = +16.0_rp*h/12.0_rp
                S(row, +1,0,0) = +16.0_rp*h/12.0_rp
                S(row, +2,0,0) = -1.0_rp*h/12.0_rp
