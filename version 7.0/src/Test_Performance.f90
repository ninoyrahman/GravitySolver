...
#include <f90papi.h>
    ...
    real(kind=double) :: init_time, comp_time, out_time,buffer
    integer :: ierr, ierror
    integer :: iteration
    ...
    buffer = init_time
    call MPI_Allreduce(buffer, init_time, 1, MPI_DOUBLE_PRECISION, MPI_MAX, cart_comm, ierr)
    buffer = comp_time
    call MPI_Allreduce(buffer, comp_time, 1, MPI_DOUBLE_PRECISION, MPI_MAX, cart_comm, ierr)
    buffer = out_time
    call MPI_Allreduce(buffer, out_time, 1, MPI_DOUBLE_PRECISION, MPI_MAX, cart_comm, ierr)
    ...
    if(rank .eq. master) then
        ...
        format = "(I5,A2,I5,A2,I5,A2,I10,A2,I5,A2,I5,A2,I5,A2,I5,A2,E10.3,A2,E10.3,A2,E10.3)"
